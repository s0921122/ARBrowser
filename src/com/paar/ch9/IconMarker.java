...
public class IconMarker extends Marker {
    ...
    public IconMarker(String name, double latitude, double longitude, double altitude, int color, Bitmap bitmap, String description) {
        super(name, latitude, longitude, altitude, color, description);
        this.bitmap = bitmap;
    }
...
//        if (symbolContainer==null) symbolContainer = new PaintablePosition(gpsSymbol, 50, 50, 0, 1);
//        else symbolContainer.set(gpsSymbol, 50, 50, 0, 1);
