...
public class Marker implements Comparable<Marker> {
	private static final Vector absSymbolVector = new Vector (100, 100, 0);
	private static final Vector absTextVector = new Vector (100, 100, 0);
	...
	public Marker(String name, double latitude, double longitude, double altitude, int color, String description) {
		set(name, latitude, longitude, altitude, color, description);
	}
	...
	public synchronized void set(String name, double latitude, double longitude, double altitude, int color, String description) {
		set (name, latitude, longitude, altitude, color);
...
//        if (symbolContainer==null) symbolContainer = new PaintablePosition(gpsSymbol, 10, 10, 0, 1);
//        else symbolContainer.set(gpsSymbol, 10, 10, 0, 1);
...
//	    if (textContainer==null) textContainer = new PaintablePosition(textBox, 10, 10, 0, 1);
//	    else textContainer.set(textBox, 10, 10, 0, 1);
