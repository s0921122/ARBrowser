...
public final class ArrayUtil {
	   ...
	   */
	  public final static int NUM_BYTES_OBJECT_REF = 0;

	  /**
	   * Number of bytes to represent an object header (no fields, no alignments).
	   */
	  public final static int NUM_BYTES_OBJECT_HEADER = 0;

	  /**
	   * Number of bytes to represent an array header (no content, but with alignments).
	   */
	  public final static int NUM_BYTES_ARRAY_HEADER = 0;
	   ...
	   */
	  public final static int NUM_BYTES_OBJECT_ALIGNMENT = 0;
...
//    assert minSize >= 0: "size must be positive (got " + minSize + "): likely integer overflow?";
//    if (array.length < minSize) {
//      int[][] newArray = new int[oversize(minSize, NUM_BYTES_OBJECT_REF)][];
//      System.arraycopy(array, 0, newArray, 0, array.length);
//      return newArray;
//    } else {
//      return array;
...
//  public static int[][] shrink(int[][] array, int targetSize) {
//    assert targetSize >= 0: "size must be positive (got " + targetSize + "): likely integer overflow?";
//    final int newSize = getShrinkSize(array.length, targetSize, NUM_BYTES_OBJECT_REF);
//    if (newSize != array.length) {
//      int[][] newArray = new int[newSize][];
//      System.arraycopy(array, 0, newArray, 0, newSize);
//      return newArray;
...
//    assert minSize >= 0: "size must be positive (got " + minSize + "): likely integer overflow?";
//    if (array.length < minSize) {
//      float[][] newArray = new float[oversize(minSize, NUM_BYTES_OBJECT_REF)][];
//      System.arraycopy(array, 0, newArray, 0, array.length);
//      return newArray;
//    } else {
//      return array;
